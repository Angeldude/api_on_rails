...
% \usemintedstyle{autogobble, breaklines}
\newminted{ruby}{autogobble, breaklines, breakanywhere, frame=single, rulecolor=\color{gray}, fontsize=\footnotesize}
\newminted{bash}{autogobble, breaklines, breakanywhere, frame=single, rulecolor=\color{gray}, fontsize=\footnotesize}
\newminted{json}{autogobble, breaklines, breakanywhere, frame=single, rulecolor=\color{gray}, fontsize=\footnotesize}
\usemintedstyle{pastie}
% \usemintedstyle{breaklines}
  ...
  \section{Initialisation du projet}
    ...
    \subsection{Installer Pow ou Prax}\label{subsection:install_pow}
      ...
      \subsubsection{Installer Prax}\label{subsubsect:prax}
        ...
        \begin{listing}
          \caption{Le Gemfile par défaut avec la Gem des sérialiseurs.}
          \label{lst:gemfile_active_model_serializers}
          \begin{rubycode}
          # Gemfile
...
\chapter{L'API}\label{chapter:2}
  ...
  \section{Améliorer le versionnement}\label{section:improve_api_versioning}
    ...
    \begin{listing}
      \caption{Gemfile avec la suite de test}
      \label{lst:add_rspect_to_gemfile}
      \begin{rubycode}
      # Gemfile
      group :test do
        gem 'rspec-rails', '~> 3.8'
    ...
    \begin{listing}
      \caption{Configuration de notre suite de test avec respec}
      \label{lst:setup_rspec}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Test de ApiConstraints}
      \label{lst:create_api_constraints_spec}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{La classe ApiConstraints}
      \label{lst:create_api_constraints}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Ajout de la contrainte à la route}
      \label{lst:add_api_constraints_to_toutes}
      \begin{rubycode}
      # config/routes.rb
...
\chapter{Présentation des utilisateurs}\label{chapter:3}
  ...
  \section{Modèle d'utilisateur}
    ...
    \begin{listing}
      \caption{Le Gemfile avec l'ajout de Devise}
      \label{lst:add_devise_to_gemfile}
      \begin{rubycode}
      # Gemfile
      source 'https://rubygems.org'
      git_source(:github) { |repo| "https://github.com/#{repo}.git" }
    ...
    \begin{listing}
      \caption{Usine d'utilsateurs}
      \label{lst:create_factories_users}
      \begin{rubycode}
  ...
  \section{Notre premier test sur le modèle User}
    ...
    \begin{listing}
      \caption{Usine d'utilisateurs avec les attributs}
      \label{lst:user_factory_with_attrs}
      \begin{rubycode}
      # spec/factories/users.rb
      FactoryBot.define do
        factory :user do
    ...
    \begin{listing}
      \caption{Test pour les attributs Devise}
      \label{lst:user_spec_with_attrs}
      \begin{rubycode}
  ...
  \section{Construire les utilisateurs}
    ...
    \begin{listing}
      \caption{Le test du contrôlleur des utilisateur}
      \label{lst:add_show_test_to_users_controller_spec}
      \begin{rubycode}
      # ...
    ...
    \begin{listing}
      \caption{Le contrôlleur des utilisateurs avec l'action 'show'}
      \label{lst:add_show_to_users_controller_spec}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Ajoute de la route Users\#Show}
      \label{lst:add_route_users_show}
      \begin{rubycode}
      # config/routes.rb
    ...
    \subsection{Tester notre ressource avec cURL}
      ...
      \begin{listing}
        \caption{Correction de la réponde de l'API}
        \label{lst:add_protect_from_forgery}
        \begin{rubycode}
    ...
    \subsection{Créer les utilisateurs}\label{subsec:create_users}
      ...
      \begin{listing}
        \caption{Ajout les tests de création des utilisateurs}
        \label{lst:add_spec_users_controller_create}
        \begin{rubycode}
      ...
      \begin{listing}
        \caption{Implémentation du contrôlleur utilisateurs afin que les tests de création passent}
        \label{lst:add_users_controller_create}
        \begin{rubycode}
    ...
    \subsection{Mettre à jour les utilisateurs}
      ...
      \begin{listing}
        \caption{Les tests du contrôlleur utilisateur avec les test de mise à jour} \label{lst:add_spec_users_controller_update}
        \begin{rubycode}
        # spec/controllers/api/v1/users_controller_spec.rb
    ...
    \subsection{Supprimer l'utilisateur}
      ...
      \begin{listing}
        \caption{Les tests du contrôlleur utilisateur avec les test de destruction} \label{lst:add_spec_users_controller_destroy}
        \begin{rubycode}
        # spec/controllers/api/v1/users_controller_spec.rb
...
\chapter{Factoriser les tests}\label{chapter:4}
  ...
  \begin{listing}
    \caption{Le fichier de test du contrôlleur avant la refactorisation}
    \label{lst:users_controller_spec_before_factorization}
    \begin{rubycode}
    # spec/controllers/api/v1/users_controller_spec.rb
  ...
  \section{Refactorisation de la réponse JSON}\label{sec:refactoring_json_response}
    ...
    \begin{listing}
      \caption{Extraction de la méthode JSON.parse}
      \label{lst:create_request_helpers}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Ajout des méthodes de request\_helpers.rb}
      \begin{rubycode}
  ...
  \section{Factoriser le paramètre du format}
    ...
    \begin{listing}
      \caption{Ajout d'un helper pour spécifier les headers des tests}
      \label{lst:add_headers_to_request_helpers}
      \begin{rubycode}
      # spec/support/request_helpers.rb
    ...
    \begin{listing}
      \caption{La version complète de la configuration de Rspec après la factorisation}
      \label{lst:complete_spec_rails_helper}
      \begin{rubycode}
      # spec/rails_helper.rb
...
\chapter{Authentification des utilisateurs}\label{chapter:5}
  ...
  \section{Session sans état and sign in failure}
    ...
    \subsection{Le jeton d'authentification}
      ...
      \begin{listing}
        \caption{Ajout des tests de réponse et d'unicité}
        \label{lst:add_uniq_test_to_user_spec}
        \begin{rubycode}
        # spec/models/user_spec.rb
      ...
      \begin{listing}
        \caption{Test de la génération automatique du jeton d'authentification}
        \label{lst:test_token_to_user_spec}
        \begin{rubycode}
        # spec/models/user_spec.rb
    ...
    \subsection{Le contrôleur de session}
      ...
      \begin{listing}
        \caption{Ajout des Namespaces pour le contrôlleur de sessions}
        \label{lst:add_namespace_for_sessions_controller}
        \begin{rubycode}
      ...
      \begin{listing}
        \caption{Ajout des Namespaces pour le test du contrôlleur de sessions}
        \label{lst:add_namespace_for_sessions_controller_spec}
        \begin{rubycode}
      ...
      \subsubsection{Connexion réussie}
        ...
        \begin{listing}
          \caption{Création des tests du contrôlleur de sessions}
          \label{lst:add_sessions_controller_spec_for_create}
          \begin{rubycode}
          # spec/controllers/api/v1/sessions_controller_spec.rb
          # ...
        ...
        \begin{listing}
          \caption{Ajout des routes pour les sessions}
          \label{lst:add_sessions_routes}
          \begin{rubycode}
          # config/routes.rb
          require 'api_constraints'
        ...
        \begin{listing}
          \caption{Implémentation de la méthode SessionsController\#create}
          \label{lst:sessions_controller_create}
          \begin{rubycode}
          # app/controllers/api/v1/sessions_controller.rb
          class Api::V1::SessionsController < ApplicationController
            def create
      ...
      \subsubsection{Déconnexion}
        ...
        \begin{listing}
          \caption{Création des test de destruction des jetons d'authentification}
          \label{lst:add_sessions_controller_spec_for_destroy}
          \begin{rubycode}
          # spec/controllers/api/v1/sessions_controller_spec.rb
          # ...
        ...
        \begin{listing}
          \caption{Création de la méthode de destruction des jetons d'authentification}
          \label{lst:add_sessions_controller_for_destroy}
          \begin{rubycode}
          # app/controllers/api/v1/sessions_controller.rb
          class Api::V1::SessionsController < ApplicationController
            # ...
  ...
  \section{Utilisateur connecté}
    ...
    \begin{listing}
      \caption{Implémentation de la méthode current\_user}
      \label{lst:create_authenticable}
      \begin{rubycode}
  ...
  \section{Authentification avec le jeton}
    ...
    \begin{listing}
      \label{lst:add_authenticate_with_token_test}
      \caption{Test de l'authentification par la méthode de jeton}
      \begin{rubycode}
      # spec/controllers/concerns/authenticable_spec.rb
      # ...
    ...
    \begin{listing}
      \label{lst:add_authenticate_with_token}
      \caption{Ajout de l'authentification par la méthode de jeton}
      \begin{rubycode}
      # app/controllers/concerns/authenticable.rb
      module Authenticable
  ...
  \section{Autoriser les actions}
    ...
    \begin{listing}
      \label{lst:use_current_user_on_users_update}
      \caption{Utilisation de la méthode current\_user pour l'action update}
      \begin{rubycode}
      # app/controllers/api/v1/users_controller.rb
      class Api::V1::UsersController < ApplicationController
    ...
    \begin{listing}
      \label{lst:add_api_authorization_helper}
      \caption{Factorisation de l'initialisation de l'en-tête Authorization}
      \begin{rubycode}
      # spec/support/request_helpers.rb
    ...
    \begin{listing}
      \label{lst:add_current_user_to_users_destroy}
      \caption{Mise à jour de l'action Users\#Destroy}
      \begin{rubycode}
      # app/controllers/api/v1/users_controller.rb
      class Api::V1::UsersController < ApplicationController
    ...
    \begin{listing}
      \caption{Utilisation de la méthode before\_action pour le controlleur des utilisateurs}
      \label{lst:add_before_action_to_users}
      \begin{rubycode}
      # app/controllers/api/v1/users_controller.rb
      class Api::V1::UsersController < ApplicationController
    ...
    \begin{listing}
      \caption{Création du test user\_signed\_in?}
      \label{lst:add_user_signed_in_test}
      \begin{rubycode}
      # spec/controllers/concerns/authenticable_spec.rb
      # ...
    ...
    \begin{listing}
      \caption{Implémetation de  user\_signed\_in?}
      \label{lst:add_user_signed_in}
      \begin{rubycode}
      # app/controllers/concerns/authenticable.rb
      module Authenticable
        # ...
...
\chapter{Produits des utilisateurs}\label{chapter:6}
  ...
  \section{Le modèle du produit}
    ...
    \subsection{Les fondements du produit}
      ...
      \begin{listing}
        \caption{Le premier test de notre modèle de produit}
        \label{lst:create_product_spec}
        \begin{rubycode}
      ...
      \begin{listing}
        \caption{Création de la factory pour le modèle produit}
        \label{lst:create_factories_products}
        \begin{rubycode}
    ...
    \subsection{Validations des produits}
      ...
      \begin{listing}
        \caption{Ajout de tests de présences pour les produits}
        \label{lst:add_presence_to_product_test}
        \begin{rubycode}
        # spec/models/product_spec.rb
        # ...
    ...
    \subsection{Liaison des produits et des utilisateurs}\label{subsec:user_has_products}
      ...
      \begin{listing}
        \caption{Ajout du test de l'association utilisateur au model du produit} \label{lst:add_should_belong_to_user}
        \begin{rubycode}
        # spec/models/product_spec.rb
        # ...
    ...
    \subsection{Suppression en cascade}
      ...
      \begin{listing}
        \caption{Test de suppression des produits liés aux utilisateurs}
        \label{lst:create_destroy_user_spec}
        \begin{rubycode}
        # spec/models/user_spec.rb
        # ...
  ...
  \section{Point d'entrée pour nos produits}
    ...
    \begin{listing}
      \caption{Le controlleur des produits généré automatqiuement}
      \label{lst:generate_products_controller}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Les test du controlleur des produits généré automatqiuement}
      \label{lst:generate_products_controller_spec}
      \begin{rubycode}
    ...
    \subsection{Action d'affichage d'un produit}
      ...
      \begin{listing}
        \caption{Test d'affichage d'un produit}
        \label{lst:products_controller_spec_show}
        \begin{rubycode}
        # spec/controllers/api/v1/products_controller_spec.rb
        # ...
    ...
    \subsection{Liste des produits}
      ...
      \begin{listing}
        \caption{Test de l'affichage des produits}
        \label{lst:create_index_products_controller_spec}
        \begin{rubycode}
        # spec/controllers/api/v1/products_controller_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Méthode d'affichage des produits}
        \label{lst:create_index_products_controller}
        \begin{rubycode}
        # app/controllers/api/v1/products_controller.rb
        class Api::V1::ProductsController < ApplicationController
          def index
    ...
    \subsection{Création des produits}\label{subsec:create_products}
      ...
      \begin{listing}
        \caption{Test de la création d'un produit}
        \label{lst:create_create_products_controller_spec}
        \begin{rubycode}
        # spec/controllers/api/v1/products_controller_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Méthode de création des produits}
        \label{lst:create_create_products_controller}
        \begin{rubycode}
        # app/controllers/api/v1/products_controller.rb
        class Api::V1::ProductsController < ApplicationController
    ...
    \subsection{Mise à jour des produits}
      ...
      \begin{listing}
        \caption{Test de mise à jour des produits}
        \label{lst:update_index_products_controller_spec}
        \begin{rubycode}
        # spec/controllers/api/v1/products_controller_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation de la mise à jour des produits}
        \label{lst:update_index_products_controller}
        \begin{rubycode}
        # app/controllers/api/v1/products_controller.rb
        class Api::V1::ProductsController < ApplicationController
    ...
    \subsection{Suppression des produits}
      ...
      \begin{listing}
        \caption{Test de suppression des produits}
        \label{lst:create_destroy_products_controller_spec}
        \begin{rubycode}
        # spec/controllers/api/v1/products_controller_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation de suppression des produits}
        \label{lst:create_destroy_products_controller}
        \begin{rubycode}
        # app/controllers/api/v1/products_controller.rb
        class Api::V1::ProductsController < ApplicationController
...
\chapter{Modélisation du JSON}\label{chapter:7}
  ...
  \begin{listing}
    \caption{Exemple de la sortie JSON actuelle pour la route products}
    \label{lst:products_json}
    \begin{jsoncode}
    {
      "products": [
          {
  ...
  \begin{listing}
    \caption{Exemple d'une belle sortie JSON pour la route products}
    \label{lst:wanted_products_json}
    \begin{jsoncode}
    {
      "products": [
          {
  ...
  \section{Sérialiser l'utilisateur}\label{sec:serialize_user}
    ...
    \begin{listing}
      \caption{Sérialsateur d'utilisateurs généré}
      \label{lst:generated_user_serializer}
      \begin{rubycode}
  ...
  \section{Sérialiser les associations}
    ...
    \begin{listing}
      \caption{Associations des utilisateurs}
      \label{lst:user_assocations}
      \begin{rubycode}
      # app/models/user.rb
      class User < ApplicationRecord
        has_many :products, dependent: :destroy
    ...
    \begin{listing}
      \caption{Associations des produits}
      \label{lst:product_assocations}
      \begin{rubycode}
      # app/models/product.rb
      class Product < ApplicationRecord
        belongs_to :user
    ...
    \begin{listing}
      \caption{Test de l'associations des produits pour l'API}
      \label{lst:spec_product_assocations}
      \begin{rubycode}
      # spec/controllers/api/v1/products_controller_spec.rb
      # ...
    ...
    \subsection{Récupérer les produits pour des utilisateurs}
      ...
      \begin{listing}
        \caption{Test de présence des identifiants des produits dans l'objet de l'utilisateur}
        \label{lst:product_ids_users_controller_spec}
        \begin{rubycode}
        # spec/controllers/api/v1/users_controller_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation pour inclures les identifiants des produits dans l'objet de l'utilisateur}
        \label{lst:product_ids_users_controller}
        \begin{rubycode}
        # app/serializers/user_serializer.rb
        class UserSerializer < ActiveModel::Serializer
      ...
      \begin{listing}
        \caption{Tests du paramètre d'identifiants des produits pour l'affichage de l'index des produits}
        \label{lst:parameter_products_controller_spec}
        \begin{rubycode}
        # spec/controllers/api/v1/products_controller_spec.rb
        # ...
  ...
  \section{Rechercher les produits}
    ...
    \subsection{Le mot-clé by}
      ...
      \begin{listing}
        \caption{Test du filtrage des produits par titre}
        \label{lst:product_filter_by_title_spec}
        \begin{rubycode}
        # spec/models/product_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation du filtrage des produits par titre}
        \label{lst:product_filter_by_title}
        \begin{rubycode}
        # app/models/product.rb
        class Product < ApplicationRecord
          # ...
    ...
    \subsection{Par prix}
      ...
      \begin{listing}
        \caption{Test du filtrage des produits par prix supérieur ou égal}
        \label{lst:product_above_or_equal_to_price_spec}
        \begin{rubycode}
        # spec/models/product_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation du filtrage des produits par prix supérieur ou égal}
        \label{lst:product_above_or_equal_to_price}
        \begin{rubycode}
        # app/models/product.rb
        class Product < ApplicationRecord
          # ...
      ...
      \begin{listing}
        \caption{Test du filtrage des produits par prix inférieur ou égal}
        \label{lst:product_below_or_equal_to_price_spec}
        \begin{rubycode}
        # spec/models/product_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation du filtrage des produits par prix supérieur ou égal}
        \label{lst:product_below_or_equal_to_price}
        \begin{rubycode}
        # app/models/product.rb
        class Product < ApplicationRecord
          # ...
    ...
    \subsection{Tri par date de création}
      ...
      \begin{listing}
        \caption{Test du filtrage des produits par date de création}
        \label{lst:product_recent_spec}
        \begin{rubycode}
        # spec/models/product_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation du filtrage des produits par date de création}
        \label{lst:product_recent}
        \begin{rubycode}
        # app/models/product.rb
        class Product < ApplicationRecord
          # ...
    ...
    \subsection{Moteur de recherche}
      ...
      \begin{listing}
        \caption{Test du moteur de recherche des produits}
        \label{lst:product_search_spec}
        \begin{rubycode}
        # spec/models/product_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation du moteur de recherche des produits}
        \label{lst:product_search}
        \begin{rubycode}
        # app/models/product.rb
        class Product < ApplicationRecord
          # ...
...
\chapter{Création des commandes}\label{chapter:8}
  ...
  \section{Modélisation de l'ordre}
    ...
    \begin{listing}
      \caption{Premiers tests du modèle de commande}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Validateurs du modèle de commande}
      \begin{rubycode}
      # app/models/order.rb
    ...
    \subsection{Les commandes et les produits}
      ...
      \begin{listing}
        \caption{Tests de l'association des commandes aux produits}
        \begin{rubycode}
        # spec/models/order_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation de l'association des commandes aux produits}
        \begin{rubycode}
        # app/models/order.rb
        class Order < ApplicationRecord
          has_many :placements
  ...
  \section{Exposer le modèle d'utilisateur}
    ...
    \begin{listing}
      \caption{Test de l'affichage des commandes}
      \begin{rubycode}
    ...
    \subsection{Afficher une seule commande}
      ...
      \begin{listing}
        \caption{Test de l'affichage d'une commande}
        \begin{rubycode}
        # spec/controllers/api/v1/orders_controller_spec.rb
        # ...
    ...
    \subsection{Placement et commandes}
      ...
      \begin{listing}
        \caption{Création de tests pour la création d'une commande}
        \begin{rubycode}
        # spec/controllers/api/v1/orders_controller_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Création de l'action de création d'une commande}
        \label{lst:orders_controller_create}
        \begin{rubycode}
        # app/controllers/api/v1/orders_controller.rb
        class Api::V1::OrdersController < ApplicationController
          # ...
      ...
      \begin{listing}
        \caption{Test de la métode du calcul de total de la commande}
        \begin{rubycode}
        # spec/models/order_spec.rb
        # ...
      ...
      \begin{listing}
        \caption{Implémentation de la métode du calcul de total de la commande}
        \begin{rubycode}
        # app/models/order.rb
        class Order < ApplicationRecord
          # ...
  ...
  \section{Envoyer un email de confirmation}
    ...
    \begin{listing}
      \caption{Test des mails de commande}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Implémetation de la méthode pour envoyer un mail lors de la création d'une commande}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Vue de l'email de confirmation de commande au format texte}
      \label{lst:order_mailer_send_confirmation_text}
      \begin{rubycode}
    ...
    \begin{listing}
      \caption{Vue de l'email de confirmation de commande au format HTML}
      \label{lst:order_mailer_send_confirmation_html}
      \begin{rubycode}
